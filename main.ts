controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    pause(5000)
    PrincessRose.startEffect(effects.fire, 5000)
    PrincessBlue.startEffect(effects.fire, 5000)
...
let nouns = ""
let sentence = ""
let PrincessViolet: Sprite = null
let PrincessSun: Sprite = null
let PrincessBlue: Sprite = null
let PrincessRose: Sprite = null
...
PrincessViolet = sprites.create(img`
    ...
    . . . . . f f b b f f . . . . . 
    `, SpriteKind.Player)
PrincessRose.setPosition(80, 35)
PrincessBlue.setPosition(100, 85)
PrincessSun.setPosition(40, 60)
PrincessViolet.setPosition(50, 100)
